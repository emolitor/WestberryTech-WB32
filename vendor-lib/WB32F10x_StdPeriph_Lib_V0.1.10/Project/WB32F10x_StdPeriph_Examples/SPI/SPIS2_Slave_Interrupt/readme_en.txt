/**
  @page SPIS2_Slave_Interrupt SPIS2_Slave_Interrupt example
  
  @verbatim
  *************** (C) COPYRIGHT 2020 - 2023 Westberry Technology ***************
  * @file    SPI/SPIS2_Slave_Interrupt/readme.txt 
  * @author  Westberry Application Team
  * @version V0.1.10
  * @date    05-January-2023
  * @brief   Description of the SPI SPIS2_Slave_Interrupt example.
  ******************************************************************************
...
This example and SPIM2_Master_Interrupt example describe how to realize the communication between SPI master and SPI slave using interrupt.
...
@par Directory contents 
  ...
  - SPI/SPIS2_Slave_Interrupt/SPIS2_Slave_Interrupt.uvprojx   MDK5 project file
  - SPI/SPIS2_Slave_Interrupt/SPIS2_Slave_Interrupt.uvoptx    MDK5 project options file
  - SPI/SPIS2_Slave_Interrupt/JLinkSettings.ini               Jlink settings file
  - SPI/SPIS2_Slave_Interrupt/main.c                          Main program
...
In order to make the program work, you must do the following :
 - Open SPIS2_Slave_Interrupt.uvprojx from this example folder by Keil MDK5
