/**
  @page SPIS1_Slave_Interrupt SPIS1_Slave_Interrupt example
...
@par Directory contents 
  ...
  - SPI/SPIS1_Slave_Interrupt/SPIS1_Slave_Interrupt.uvprojx   MDK5 project file
  - SPI/SPIS1_Slave_Interrupt/SPIS1_Slave_Interrupt.uvoptx    MDK5 project options file
  - SPI/SPIS1_Slave_Interrupt/JLinkSettings.ini               Jlink settings file
  - SPI/SPIS1_Slave_Interrupt/main.c                          Main program
...
In order to make the program work, you must do the following :
 - Open SPIS1_Slave_Interrupt.uvprojx from this example folder by Keil MDK5
