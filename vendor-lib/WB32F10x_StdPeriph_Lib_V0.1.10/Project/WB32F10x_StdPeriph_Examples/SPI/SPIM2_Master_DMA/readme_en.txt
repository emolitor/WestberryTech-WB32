/**
  @page SPIM2_Master_DMA SPIM2_Master_DMA example
  
  @verbatim
  *************** (C) COPYRIGHT 2020 - 2023 Westberry Technology ***************
  * @file    SPI/SPIM2_Master_DMA/readme.txt 
  * @author  Westberry Application Team
  * @version V0.1.10
  * @date    05-January-2023
  * @brief   Description of the SPI SPIM2_Master_DMA example.
  ******************************************************************************
...
This example and SPIS2_Slave_DMA example describe how to realize the communication between SPI master and SPI slave using DMA.
...
@par Directory contents 
  ...
  - SPI/SPIM2_Master_DMA/SPIM2_Master_DMA.uvprojx   MDK5 project file
  - SPI/SPIM2_Master_DMA/SPIM2_Master_DMA.uvoptx    MDK5 project options file
  - SPI/SPIM2_Master_DMA/JLinkSettings.ini          Jlink settings file
  - SPI/SPIM2_Master_DMA/main.c                     Main program
...
In order to make the program work, you must do the following :
 - Open SPIM2_Master_DMA.uvprojx from this example folder by Keil MDK5
