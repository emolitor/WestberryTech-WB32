/**
  @page SPIM2_Master_Interrupt SPIM2_Master_Interrupt example
  
  @verbatim
  *************** (C) COPYRIGHT 2020 - 2023 Westberry Technology ***************
  * @file    SPI/SPIM2_Master_Interrupt/readme.txt 
  * @author  Westberry Application Team
  * @version V0.1.10
  * @date    05-January-2023
  * @brief   Description of the SPI SPIM2_Master_Interrupt example.
  ******************************************************************************
...
This example and SPIS2_Slave_Interrupt example describe how to realize the communication between SPI master and SPI slave using interrupt.
...
The BoardA needs to download the SPIM2_Master_Interrupt program, and the BoardB needs to download the SPIS1_Slave_Interrupt program.
...
In SPIM2_Master_Interrupt program, SPIM2 peripheral is configured as Master full duplex with interrupt,and the bit rate is configured as 1 Mbit/s. \n
In SPIS2_Slave_Interrupt program, SPIS2 peripheral is configured as Slave Full duplex with interrupt.
...
@par Directory contents 
  ...
  - SPI/SPIM2_Master_Interrupt/SPIM2_Master_Interrupt.uvprojx   MDK5 project file
  - SPI/SPIM2_Master_Interrupt/SPIM2_Master_Interrupt.uvoptx    MDK5 project options file
  - SPI/SPIM2_Master_Interrupt/JLinkSettings.ini                Jlink settings file
  - SPI/SPIM2_Master_Interrupt/main.c                           Main program
...
In order to make the program work, you must do the following :
 - Open SPIM2_Master_Interrupt.uvprojx from this example folder by Keil MDK5
