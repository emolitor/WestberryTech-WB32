/**
  @page QSPI_Master_Interrupt QSPI_Master_Interrupt example
  
  @verbatim
  *************** (C) COPYRIGHT 2020 - 2023 Westberry Technology ***************
  * @file    SPI/QSPI_Master_Interrupt/readme.txt 
  * @author  Westberry Application Team
  * @version V0.1.10
  * @date    05-January-2023
  * @brief   Description of the SPI QSPI_Master_Interrupt example.
  ******************************************************************************
...
This example and SPIS1_Slave_Interrupt example describe how to realize the communication between SPI master and SPI slave using interrupt.
...
@par Directory contents 
  ...
  - SPI/QSPI_Master_Interrupt/QSPI_Master_Interrupt.uvprojx   MDK5 project file
  - SPI/QSPI_Master_Interrupt/QSPI_Master_Interrupt.uvoptx    MDK5 project options file
  - SPI/QSPI_Master_Interrupt/JLinkSettings.ini               Jlink settings file
  - SPI/QSPI_Master_Interrupt/main.c                          Main program
...
In order to make the program work, you must do the following :
 - Open QSPI_Master_Interrupt.uvprojx from this example folder by Keil MDK5
