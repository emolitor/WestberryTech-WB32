...
本例程与SPIS1_Slave_Interrupt例程演示如何以中断的方式完成SPI主机和SPI从机之间的通信。
...
@par 目录内容 
  ...
  - SPI/QSPI_Master_Interrupt/QSPI_Master_Interrupt.uvprojx   MDK5工程文件
  - SPI/QSPI_Master_Interrupt/QSPI_Master_Interrupt.uvoptx    MDK5工程配置文件
  - SPI/QSPI_Master_Interrupt/JLinkSettings.ini               Jlink配置文件
  - SPI/QSPI_Master_Interrupt/main.c                          主程序
...
为了使程序工作，您必须执行以下操作 :
 - 使用 MDK5 打开此例程文件夹中的 QSPI_Master_Interrupt.uvprojx 工程
 - 重新编译该工程并下载到目标存储器中
 - 运行此例程
