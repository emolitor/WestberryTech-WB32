...
本例程与SPIS1_Slave_DMA例程演示如何以DMA的方式完成SPI主机和SPI从机之间的通信。
...
@par 目录内容 
  ...
  - SPI/QSPI_Master_DMA/QSPI_Master_DMA.uvprojx   MDK5工程文件
  - SPI/QSPI_Master_DMA/QSPI_Master_DMA.uvoptx    MDK5工程配置文件
  - SPI/QSPI_Master_DMA/JLinkSettings.ini         Jlink配置文件
  - SPI/QSPI_Master_DMA/main.c                    主程序
...
为了使程序工作，您必须执行以下操作 :
 - 使用 MDK5 打开此例程文件夹中的 QSPI_Master_DMA.uvprojx 工程
 - 重新编译该工程并下载到目标存储器中
 - 运行此例程
