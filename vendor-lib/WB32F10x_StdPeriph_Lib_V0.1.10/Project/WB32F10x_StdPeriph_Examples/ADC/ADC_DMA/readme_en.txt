...
This example describes how to use the ADC and DMAC to transfer continuously converted data of regular group from ADC to memory.
...
@par Directory contents 
  ...
  - ADC/ADC_DMA/ADC_DMA.uvprojx        MDK5 project file
  - ADC/ADC_DMA/ADC_DMA.uvoptx         MDK5 project options file
  - ADC/ADC_DMA/JLinkSettings.ini      Jlink settings file
...
In order to make the program work, you must do the following :
 - Open ADC_DMA.uvprojx from this example folder by Keil MDK5
