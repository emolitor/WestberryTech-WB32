...
@par 目录内容 
  ...
  - TIM/TIM_ParallelSynchro/TIM_ParallelSynchro.uvprojx   MDK5工程文件
  - TIM/TIM_ParallelSynchro/TIM_ParallelSynchro.uvoptx    MDK5工程配置文件
  - TIM/TIM_ParallelSynchro/JLinkSettings.ini             Jlink配置文件
  - TIM/TIM_ParallelSynchro/main.c                        主程序
...
为了使程序工作，您必须执行以下操作 :
 - 使用 MDK5 打开此例程文件夹中的 TIM_ParallelSynchro.uvprojx 工程
 - 重新编译该工程并下载到目标存储器中
 - 运行此例程
