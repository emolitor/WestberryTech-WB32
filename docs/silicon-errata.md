...
Known hardware errata and driver-level issues for WB32F10x and WB32FQ95xx microcontrollers, discovered through register-level hardware testing and production firmware validation.
